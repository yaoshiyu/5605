...
RUN;
PROC UNIVARIATE DATA=OUTFILE NORMAL PLOT;
VAR YRES;
RUN;
PROC PLOT DATA=OUTFILE;
PLOT STUDENT*YPRED/VREF=0;
PLOT STUDENT*X1/VREF=0;
PLOT STUDENT*X2/VREF=0;
PLOT STUDENT*X3/VREF=0;
PLOT STUDENT*X4/VREF=0;
PLOT STUDENT*X5/VREF=0;
RUN;
ods rtf close;
